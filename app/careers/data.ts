...
export const jobOpenings: Job[] = [
  {
    ...
    type: "full-time",
    description: "Build and optimize modern web applications using cutting-edge technologies.",
 ...
 
  {
    ...
    requirements: [
      ...
      "Proficiency with social media platforms (e.g., LinkedIn, Twitter, Instagram)",
      "Basic content writing and editing skills (e.g., Grammarly, Canva)",
